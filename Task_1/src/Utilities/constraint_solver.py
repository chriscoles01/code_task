...
class ConstraintSolver:
    @staticmethod
    def get_solution(genome_index:pd.Index, genome_constraints:pd.DataFrame, i:int) -> dict:
        solutions = {}
        final_solution = {}
        ...
        while solutions is not None:
            ...
            if solutions is not None:
                ...
                print("no solution for", i-1, "groups, therefore optimal solution is", i, "groups")
    ...
    @staticmethod
    def _add_next_region_to_row(df : pd.DataFrame, order : pd.DataFrame, existing:list):
